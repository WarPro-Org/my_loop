...
///
/// None of them writes `myRank` into [userProfileProvider]: the board is a snapshot
/// that `LeaderboardRefreshWorker` rebuilds only every few minutes (#109), while the
/// Home rank tile gets its LIVE rank from game-state hydration at sign-in,
/// onboarding and after each walk (`hydrateAndSyncProfileRank`). Copying the snapshot rank here would roll the tile
/// back to a pre-walk rank just for opening this screen.
