...
MyLoop is a habit tracking app with a Flutter mobile client and a .NET 10 REST API backend.
Auth is handled via Firebase JWT. The project is in closed beta.
